...
router.post("/createuser", [body('email', "Enter a valid email").isEmail(), body('name', "Enter a valid name").isLength({ min: 3 }), body('password', "Password must be atleast 5 characters").isLength({ min: 5 })
], async (req, res) => {
    let success = false;
...
// ROUTE 4: Update User account using:POST "/api/auth/getUser". Login required
